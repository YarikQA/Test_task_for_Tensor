...
class YandexSearchPage(BasePage):
    def user_should_see_search_bar(self):
        assert self.is_element_on_page(*YandexBasePageLocators.SEARCH_BAR), "Can't find the Search bar"
    ...
    def user_should_see_suggest_list(self):
        assert self.is_element_on_page(*YandexBasePageLocators.SUGGEST_LIST), "Can't find suggest list"
